...
class ExpandableListitem extends Component<any, any> {
  state = {
    panelStatus: false,
  };
  ...
  render() {
    const { title = "", expanded = false} = this.props;
    const { panelStatus } = this.state;
    const panelExpandStatus = panelStatus || expanded;

    return (
      <div className="expandable-list-item">
        <div
          className="expandable-list-item__panel-header"
        ...
        >
          ...
          <div className="expandable-list-item__panel-header-actions">
            { panelExpandStatus ? <PanelOpenIcon /> : <PanelCloseIcon />}
          </div>
        </div>

        { panelExpandStatus && (
          <div className="expandable-list-item__panel-body">
            {this.props.children}
          </div>
        )}
      </div>
