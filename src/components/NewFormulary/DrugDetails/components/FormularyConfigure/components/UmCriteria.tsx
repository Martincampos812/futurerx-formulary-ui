...
import {
  UmCrtieriasColumns,
  UmCrtieriasPaColumns,
  UmCrtieriasQlColumns,
  UmCrtieriasStColumns,
} from "../../../../../../utils/grid/columns";
import { getAdditionalCriteriaSectionList } from "../../../../NewAdvanceSearch/advanceSearchMock";
import "./UmCriteria.scss";
class UmCriteria extends React.Component<any, any> {
  ...
  componentWillReceiveProps(nextProps) {
    if (Object.keys(nextProps.umCriterias).length > 0) {
      ...
      //this.setState({additionalCriteriaBody: payload.additionalCriteriaBody});
      // this.additionalCriteriaBody = payload.additionalCriteriaBody;
      if (!this.props.additionalCriteria.additionalCriteriaBody) {
        this.props.setAdditionalCriteria(payload);
      }
  ...
  render() {
    return (
      <div className="inner-container input-border-none root-um-criteria">
        ...
        <div>
          ...
          <Button
            ...
            className="Button"
            onClick={(event) => {
              this.populateGridData(null, false, true);
            }}
            disabled={false}
          />
        </div>
        <AdditionalCriteriaContainer
          ...
          handleChildDataSave={() => {}}
          isReadOnly={true}
          // additionalCriteriaBody_1={this.additionalCriteriaBody}
        />
...
function mapDispatchToProps(dispatch) {
  return {
    postFormularyDrugUmCriterias: (a) =>
      dispatch(postFormularyDrugUmCriterias(a)),
    postUmCriteriasDrugs: (a) => dispatch(postUmCriteriasDrugs(a)),
    setAdditionalCriteria: (a) => dispatch(setAdditionalCriteria(a)),
  };
}

export default connect(mapStateToProps, mapDispatchToProps)(UmCriteria);
