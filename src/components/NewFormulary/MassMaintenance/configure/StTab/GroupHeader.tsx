...
import { SUCCESS_MSG, ERROR_MSG } from "../../../DrugDetails/components/FormularyConfigure/components/PopupAlerts/Constents";
import STAlertDialog from "../../../DrugDetails/components/FormularyConfigure/components/STAlertDialog";
import Alerts from "../../../DrugDetails/components/FormularyConfigure/components/PopupAlerts/Alerts";
...
import "../../../DrugDetails/components/FormularyConfigure/components/PAGroupHeader.scss";
...
function GroupHeader(props: any) {
  ...
  const toggleShowViewAll = () => {
    ...
    } else if (props.formulary_lob_id != 1) {
      setIdField("formulary_id");
    }
