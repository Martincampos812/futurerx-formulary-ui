...
import Groups from "../../../DrugDetails/components/FormularyConfigure/components/Groups";
...
function mapStateToProps(state) {
  return {
    ...
    formulary_id: state.maintenance?.selectedRow?.id_maintenance_formulary,
    formulary: state?.application?.formulary,
    formulary_lob_id: state.maintenance?.selectedRow?.id_lob, //comme- 4, medicare-1 , medicate-2, exchnage -3
    // additional criteria
...
class PaGroupDescriptionManagement extends React.Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.getPaGrouptDescriptions(apiDetails).then((json) => {
      ...
      } else if (this.props.formulary_lob_id != 1) {
